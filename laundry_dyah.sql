...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Okt 2023 pada 07.39
...
--
ALTER TABLE `tb_user`
  ADD CONSTRAINT `tb_user_ibfk_1` FOREIGN KEY (`id_outlet`) REFERENCES `tb_paket` (`id_outlet`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
